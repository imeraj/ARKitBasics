...
class ViewController: UIViewController, ARSCNViewDelegate, UIGestureRecognizerDelegate {
    ...
    lazy var infoLabel: UILabel = {
        ...
        label.backgroundColor = UIColor(red: 1.0, green: 0.0, blue: 0.0, alpha: 0.50)
        return label
    }()
    ...
    override func viewDidLoad() {
        ...
        sceneView.debugOptions = [.showConstraints, .showLightExtents, ARSCNDebugOptions.showFeaturePoints]
